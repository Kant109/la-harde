<template>
  <div class="card group cursor-pointer">
    ...
    <div class="relative overflow-hidden h-64">
      ...
      />
      <div class="absolute inset-0 transition-all duration-300 group-hover:opacity-100 opacity-0" style="background: var(color-secondary);"></div>
    ...
    <div class="p-6">
      ...
      <p class="text-base leading-relaxed font-medium" style="color: var(--color-secondary);">
        {{ member.bio }}
      </p>
    </div>
  </div>
